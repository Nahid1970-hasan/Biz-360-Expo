...
import { deleteBIZTempMenuData } from "./biz_template_menu_slice";

 

export const BIZTempDelete = ({ open, setOpen = () => { }, data }) => {
    ...
    function deleteItem(e) {
        e.preventDefault(); 
        dispatch(deleteBIZTempMenuData(data)); 
    }
    return <Modal  title={t("del_biz_menu_msg")} xs={4} open={open} onClose={() => {
        setOpen(false);
      }} outsideclick>
         <Flex row ="row">
