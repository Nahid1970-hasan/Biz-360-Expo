...
import { deleteAdDisplaySetup } from "./ad_dislay_setup_slice";

 

export const AdDisplayDelete = ({ open, setOpen = () => { }, data }) => {
    ...
    function deleteItem(e) {
        e.preventDefault(); 
        dispatch(deleteAdDisplaySetup(data)); 
    }
    return <Modal  title={t("del_display")} xs={4} open={open} onClose={() => {
        setOpen(false);
      }} outsideclick>
         <Flex row ="row">
