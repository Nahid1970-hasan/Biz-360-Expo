...
import { calcAdCost, saveInvAdvtismentData, updateInvAdvtismentData } from "./inv_advert_Slice";
...
export const AdvertisementModal = ({
    ...
    const validate = (Values) => {
        ...
        if (!Values.content_id) {
            errors.content_id = t("err_msg_content_name");
        ...
        if (!Values.dimension_id) {
            errors.dimension_id = t("err_msg_dimension_name");
        }
