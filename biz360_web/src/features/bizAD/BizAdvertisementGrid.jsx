...
import { BizAdvertisementModal } from "./BizAdvertisementModal";
import { BizAdvertisementDelete } from "./BizAdvertisementDelete";

export const BizAdvertisementGrid = ({ gridata }) => {
    ...
    return <Suspense>
        ...
        <BizAdvertisementModal open={open} setOpen={setOpen} data={data} />
        <BizAdvertisementDelete open={remove} setOpen={setRemove} data={{ad_id}} /> 
    </Suspense>;
}