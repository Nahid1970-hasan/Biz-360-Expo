import { GridScroll, StyledDatagrid } from "../style/styled_datagrid";
...
export default function ({ colums, rows, selectable, maxheight = "85vh", getSelectedIds, getAllRows }) {
  ...
  return (
    <GridContext.Provider value={{ mainSelect, setMainSelect, selectable, colums: dataColums, setColumns: setDataColums, rows: dataRows, setRows: setDataRows, sortGrid: useCallback(sortGrid, [asc, dataRows]), asc: asc }}>
      <GridScroll maxheight={maxheight}>
        <StyledDatagrid>
          <div>
            <div>
              <HeaderBuilder />
