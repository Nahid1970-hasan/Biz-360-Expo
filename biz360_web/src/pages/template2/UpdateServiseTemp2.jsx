...
import { SetupServiseTemp2Modal } from "./SetupServiseTemp2Modal";

export const UpdateServiseTemp2 = () => {
    ...
    return (<>
        <Suspense>
            <Flex row="true">
                <Flex padding={"5px !important"} md={12}>
                    <InfoCard>
                        <InlineDiv>
                            <Label>{t("product_&_servise_section", { lng: menuLang })}</Label>
                ...
                <Flex md={12}>
                    <ShadowCard>
                        ...
                        <SizeBox/>
                        <Typography fntsize="cardSubTitleFontSize" fntweight="bold">{basicData?.page_subtitle||""}</Typography> 
                        <SizeBox/>
                        <Typography fntsize="cardSubTitleFontSize" txtalign="left" fntweight="bold">{basicData?.section1_title||""}</Typography> 
                        <SizeBox/>
                        <Typography fntsize="cardContentFontSize" txtalign="left">{basicData?.section1_subtitle||""}</Typography> 
                        <SizeBox/>
                        <Typography fntsize="cardSubTitleFontSize" txtalign="left" fntweight="bold">{basicData?.section2_title||""}</Typography> 
                        <SizeBox/>
                        <Typography fntsize="cardContentFontSize" txtalign="left">{basicData?.section2_subtitle||""}</Typography> 
                        <SizeBox/>
                        <Typography fntsize="cardSubTitleFontSize" txtalign="left" fntweight="bold">{basicData?.section3_title||""}</Typography> 
                        <SizeBox/>
                       <Typography fntsize="cardContentFontSize" txtalign="left"><li>{basicData?.section3_subtitle||""}</li> </Typography> 
        ...
        <SetupServiseTemp2Modal open={abtOpen} setOpen={setAbtOpen} data={[]} />
    </>)
}