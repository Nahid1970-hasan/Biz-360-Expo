...
import signImg from "../assets/sign-up-process-330x460.png";
            ...
            <Suspense>
                <Container>
                    <Flex row="row" >
                        ...
                        <InfoCard>
                            <Flex row="row">
                                <Flex md={9} padding="0 0 10px 0!important">
                                ...
                                <Flex md={3} padding="0 0 10px 0!important">
                                    <KDImg src={signImg} width={"100%"} height={"460px"} noborder="true" padding="0!important"></KDImg>
                                    <CardHeaderButton padding="0 20px 0 0 ">
                                    <PrimaryButton
