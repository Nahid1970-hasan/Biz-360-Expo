...
import { Card, CardBody, CardHeaderButton, HoverCard, InfoCard } from "../component/style/styled_card";
import { Select } from "../component/style/styled_select";
import { SizeBox } from "../component/style/styled_sizebox";
import { PhoneInput } from "react-international-phone";
import 'react-international-phone/style.css';
import { initLoader } from "../features/pubRegistration/pub_registration_slice";
...
import img from "../assets/hat_bazar.jpg";

export const Membershipdemo = () => {
    ...
    return bizGroupData.loading == "nonetwork" ? <NotNetwork /> : (
        <>
            ...
            <Suspense>
                <Container>
                    <Flex md={12} padding="10px 0 0 0">
                        <InfoCard>
                            <Typography fntsize="cardTitleFontSize" fntweight="bold"> {t("membership_title")}</Typography>

                        </InfoCard>
                    </Flex>
                    {!group_id ?
                        <Flex row="row">
                            <Flex md={2} padding=" 10px 0!important">
                                <InfoCard>
                                    <Flex md={12} padding="0!important">
                                        <InlineFlex justifycontent="start" style={{ position: 'relative', width: 'fit-content' }}>
                                            <div
                                            ...
                                            >
                                                <KDImg
                                                    ...
                                                    height={"200px"}
                                                    noborder="true"
                                                // style={{ filter: 'blur(1px)', borderRadius: '8px' }}
                                                />
                                                <PrimaryButton
                                                    style={{
                                                        position: 'absolute',
                                            ...
                                            <Flex md={3} key={i} padding="0 !important">
                                                <IconButton width="100%" color={"font"} height={"100%"} onClick={() => set_group_id(d.group_id)} nothover={"true"}>
                                                    <ListTooltip width="100%" position={'right'} color="font" background={'bg'} title={d.main_names || []}>
                                                        <Flex row="row">
                                                            <Flex md={12} padding="0 !important">
                                                                {d.group_image && <KDImg src={d.group_image || bazar} height={"150px"} width={"100%"} padding="0 !important" />}
                                                            </Flex>
                                                            {/* <Flex md={12} padding="0 !important">
                            ...
                            <Flex md={3} padding="10px 0 !important">
                                <InfoCard>
                                    <Flex row="row">
            ...
            <TermsConditionModal open={isAgree} setOpen={setIsAgree} reqdata={reqData} member_type={member_type} />
        </>
