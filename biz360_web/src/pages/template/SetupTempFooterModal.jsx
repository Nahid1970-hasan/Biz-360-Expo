...
import { addDataList, selectIMLink, selectSCLink, selectSPPList, updateTemplateContent } from "./temp_footer_setup_data_slice";

export const SetupTempFooterModalPage = ({ open, setOpen = () => { }, data }) => {
    ...
    useEffect(() => {
        ...
        var datad = {
            ...
            importantList: data?.important_link?.link || IMPORTANTLINK,
    ...
    function handleSubmit() {
        var data = {
            ...
            "important_link": {
                ...
                "link": admFTTmpListData?.importantLinkList
            },
            "social_media": {
                ...
                <Flex row="row" justifycenter="true" >
                    ...
                    <Flex row="true">
                        <Flex md={6} padding="0 !important">
                            <Label margin={"8px 0 5px 0"}>{t("important_link")}</Label>
                            <ULine />
                            {
                                admFTTmpListData?.importantLinkList?.map((d, i) => <CheckboxLabel id={"imp_" + d.id} key={i} checked={d.status == "Active" ? 1 : 0} onClick={(e) => { dispatch(selectIMLink(e.target.id)) }} label={d.name} labelcolor="font" size={"md"} />)
                            }
                        </Flex>
