...
import { SetupTempBDCSC1ModalPage } from "./SetupBDCSection1Modal";
import { Input } from "../../component/style/styled_input";
import { Formik } from "formik";
import { Modal } from "../../component/Modal";
import { updateTempBDCSC } from "./temp_body_setup_data_slice";

export const UpdateTempBodyOfferPage = () => {
                            ...
                            <Flex row="true">
                                <Flex md={12}>
                                    <Typography fntsize="cardTitleFontSize" txtalign="left" fntweight="bold">
                                        {section1data?.section1_title || t("offer_products")} {"( " + section1data?.data?.length + " Products Found )"}
                                    </Typography>
                                </Flex>
