...
export const MUpdateTempTermsConPage = () => {
    ...
    useEffect(() => {
        if (tempInfo.template_id > 0) {
            dispatch(loadMTempBodyData({ template_id: tempInfo.template_id, page_name: "terms-condition", section_name: "", sub_section_name: "" }));
        }
    }, [tempInfo]);
    ...
    const handleOnSubmit = (e) => {
        dispatch(saveMTempBodyData({ template_id: tempInfo.template_id, page_name: "terms-condition", photo_name: '', sub_section_name: "", section_name: "section1", 'content': JSON.stringify({ 'page_data': output }) }))
