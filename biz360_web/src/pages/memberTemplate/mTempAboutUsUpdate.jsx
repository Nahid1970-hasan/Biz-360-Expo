...
export const MUpdateTempAbtUsPage = () => {
    ...
    useEffect(() => { 
        dispatch(loadPage({ title: 'about_us_template' }))
    }, []);
    ...
    useEffect(() => {
        if (tempInfo.template_id > 0) {
            dispatch(loadMTempBodyData({ template_id: tempInfo.template_id, page_name: "about-us", section_name: "", sub_section_name: "" }));
        }
    }, [tempInfo]);
    ...
    const handleOnSubmit = (e) => {
        dispatch(saveMTempBodyData({ template_id: tempInfo.template_id, page_name: "about-us", photo_name: '', sub_section_name: "", section_name: "section1", 'content': JSON.stringify({ 'page_data': output }) }))
    }
           ...
           <Flex row={"true"}> 
                    <Flex md={12} sm={12} xs={12} padding="0">
                        <RichTextEditor
                            ...
                            initialValue={sectionAbtData?.page_data ||""}
                            customizeUI={{
                                backgroundColor: '#fff',
                                primaryColor: '#30b256',
                            }}
