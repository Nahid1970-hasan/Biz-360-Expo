...
import { SetupTempSeasonalFContModalPage } from "./UpdateTempSeasonalFContModal";

export const UpdateTempSeasonalFContPage = () => {
    ...
    return (<>
        ...
        <SetupTempSeasonalFContModalPage open={cntOpen} setOpen={setCntOpen} data={cntDataList || {}} />
    </>)
}