...
import { SetupTempSeasonalFFooterModalPage } from "./UpdateTempSeasonalFTModal";
import { loadPage } from "../../features/page/page_slice";

export const UpdateTempSeosonalHFPage = () => {
    ...
    return (<><Suspense>
        <Flex row="true">
          ...
          <SetupTempSeasonalFFooterModalPage open={footerOpen} setOpen={setFooterOpen} data={footerData || {}} />
