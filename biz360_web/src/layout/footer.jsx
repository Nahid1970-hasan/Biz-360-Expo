      ...
      <FooterStyled color="font">
        <Container border={"none"}>
          ...
          <Flex padding="10px 0 0 0 !important" md={12}>
            <Typography fnfamily="var(--dashboard-font)" fntsize="bodyTitleFontSize" color="primaryFont" width={"100%"}>
              The information provided in this website is for non-commercial use only.
            </Typography>
            <SizeBox/>
            </Flex>
            <Flex padding="10px 0 0 0 !important" md={3}>
              ...
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><a href="tel:01703121360">01703121360</a></FooterMenu>
              </Typography>
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><a href="tel:01723151360">01723151360</a></FooterMenu>
              </Typography>
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><a href="mailto:contact@Biz360Expo.com">contact@Biz360Expo.com</a></FooterMenu>
              </Typography>
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><a href="mailto:marketing@Biz360Expo.com">marketing@Biz360Expo.com</a></FooterMenu>
              </Typography>
            </Flex>
            <Flex padding="10px 0 0 0 !important" md={3}>
              <Typography fntsize="bodyTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
              ...
              <SizeBox />
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><Link href="/#/privacy" target="blank">Privacy Policy</Link></FooterMenu>
              </Typography>
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><Link href="/#/termcond" target="blank">Terms & Conditions</Link></FooterMenu>
              </Typography>
              <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                <FooterMenu><Link to="/pub-faq">FAQs</Link></FooterMenu>
              </Typography>
            </Flex>
          ...
          <Flex row="row" justifycenter="true">
            <Flex md={12} padding="0!important">
              <Typography fnfamily="var(--dashboard-font)" fntsize="bodyTitleFontSize" color="primaryFont" width={"100%"} margin="5px 0">
                Copyright © {getCurrentYear()} King <b>Digital</b> Recharge Limited (K<b>D</b>RL) | All Rights Reserved.
              </Typography>
            </Flex>
          </Flex>
        </Container>
