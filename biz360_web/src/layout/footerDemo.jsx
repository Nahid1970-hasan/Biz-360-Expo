        ...
        <>
            <FooterStyled color="font">
                <Container border={"none"} >
                    <Flex row="row">
                        <Flex padding="0 10px 0 0 !important" md={3}>
                            <Border>

                                <KDImg src={footer} height={"auto"} width={"auto"} noborder="true" padding="0 20px !important" />

                                <Typography fntsize="bodyTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" margin="10px 0 0 0">
                                    {t("cust_support")}
                                </Typography>
                                <SizeBox />
                                <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" incnum={1} incnumtype="decr">

                                    <a href="tel:01703121360">  01703121360</a>
                                </Typography>
                                <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" incnum={1} incnumtype="decr">
                                    <a href="tel:01723151360">01723151360</a>
                                </Typography>
                                <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" margin="20px 0 0 0" incnum={1} incnumtype="decr">
                        ...
                        <Flex padding="20px 0 0 0 !important" md={2}>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/pabout" target="blank">{t("perception")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/pabout" target="blank">{t("core_concept")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/pabout" target="blank">{t("about_biz360")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/pabout" target="blank">{t("purpose")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/pabout" target="blank">{t("key_fea")}</Link>
                            </Typography>
                            {/* <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" margin="20px 0 0 0">
                                <Link href="/ftfeedback" target="blank">{t("your_feedback")}
                                </Link>
                            </Typography> */}
                            {/* <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/">{t("blog")}
                        ...
                        <Flex padding="20px 0 0 0  !important" md={2}>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                ...
                                <Link href="/pmember" target="blank">{t("ben_member")}</Link>

                            </Typography>

                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/difplatfrm" target="blank">{t("dif_plat")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" margin="20px 0 0 0">

                                <Link href="/identitybiz" target="blank">{t("identity_biz")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" >
                                <Link href="/cpyright" target="blank">{t("copyright")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" margin="20px 0 0 0">
                                <Link href="/crvalue" target="blank">{t("principles")}</Link>

                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">

                                <Link href="/crvalue" target="blank">{t("core_value")}</Link>

                            </Typography>
                        </Flex>
                        <Flex padding="20px 0 0 0 !important" md={2}>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/termcond" target="blank">{t("term_service")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                            ...
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left" margin="20px 0 0 0">
                                <Link href="/pgintch" target="blank">{t("contact_us")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">

                                <Link href="/pgintch" target="blank">{t("cust_service")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/viwdemo" target="blank">{t("view_demo")}</Link>
                            </Typography>
                            <Typography fntsize="bodySubTitleFontSize" color="bodyContent" width={"100%"} txtalign="left">
                                <Link href="/pfaq">{t("faq")}</Link>
                            </Typography>
                        </Flex>
                        <Flex padding="20px 0 0 10px !important" md={3}>
                            <Typography fntsize="bodyTitleFontSize" color="bodyContent" width={"100%"} margin="0 25px 0 0 ">
                                {t("connect_us")}
                            </Typography>
                            <SizeBox />
                            <Flex row="row">
                                <Flex padding="0 35px !important" md={4}>
                                    <Typography>
                                        <FooterMenu>

                                            <a href="https://www.facebook.com/" target="_blank"><Icon hvcolor="white" hvfill="white" hvback="blue" color="black" data-feather="facebook" hover="true" size={40} />
                                                {/* <label>Facebook</label> */}
                                                <IconLabel>Facebook</IconLabel>
                                            </a>


                                        </FooterMenu>  </Typography>
                                    <FooterMenu>
                                        <a href="https://www.twitter.com/" target="_blank"><Icon hvcolor="white" hvfill="white" hvback="#0dbbe0" color="black" data-feather="twitter" hover="true" size={40} />
                                            {/* <label>Twitter</label> */}
                                ...
                                <Flex padding="0 30px !important" md={4}>

                                    <FooterMenu>
                                        <a href="https://www.youtube.com/" target="_blank"><Icon hvcolor="red" hvfill="white" hvback="red" data-feather="youtube" hover="true" size={40} />
                                            {/* <label>Youtube</label> */}
                                ...
                                <Flex padding="0 25px  !important" md={4}>
                                    <FooterMenu>
                                        <a href="https://wa.me/01703121360" target="_blank">
                                    ...
                                    <FooterMenu>
                                        <a href="https://telegram.me/biz360expo" target="_blank">
                    ...
                    <Flex row="row" justifycenter="true">
                        <Flex md={12} padding=" 10px 0 0 0!important">
                            <Typography fnfamily="var(--dashboard-font)" fntsize="bodyTitleFontSize" color="primaryFont" width={"100%"} margin="5px 0" incnum={1} incnumtype="decr">
                                © {getCurrentYear() === 2025 ? 2025 : `2025 - ${getCurrentYear()}`} Biz 360 Expo | All Rights Reserved. | {" "}
                                <Link href="/sitemap">{t("site_map")}</Link>
