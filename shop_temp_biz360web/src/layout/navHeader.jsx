...
import bizexpo from "../assets/biz360expo.jpg";

import { KDImg } from "../component/style/styled_img";
import { StyledPubNavbar } from "../component/style/styled_pub_nav";
import { StyledPubNavHeader } from "../component/style/styled_pub_nav_header";
        ...
        <>
            ...
            <StyledMainNavbar>
                <Container border={"none"}>
                    <div>
                        <StyledMainNavbarUL>
                            <NavLink to={"/"}><KDImg padding="5px 0" width={"100px"} height={"60px"} src={bizexpo} noborder="true" /></NavLink>
                        </StyledMainNavbarUL>
                        <StyledMainNavbarUL>
                            {menuData?.map((item, i) => (
