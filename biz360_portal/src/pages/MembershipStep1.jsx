...
import { updateUserInfo } from "../features/pubRegistrastion/pub_registration_slice";
        ...
        <Flex row="row" justifycenter="true">
            ...
            <Flex row="row">
                <Flex md={8} padding="0 0 10px 0!important">
                    ...
                    <Typography fntsize="bodySubTitleFontSize" txtalign="justify" margin="5px 0" >
                        {t("guidelines_header")}
                    </Typography>
                    <Flex row="row">
