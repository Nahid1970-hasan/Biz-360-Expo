...
export const StyledTemp6Navbar = styled.nav`
...
export const StyledTemp6NavbarUL = styled.ul`
    display: flex;
    list-style: none;
    align-items: center;
    justify-content: center;
...
export const StyledTemp6NavbarLI = styled.li` 
    &>select{
        padding: 2px 0; 
...
export const StyleTemp6DDBackground = styled.div`
...
`
export const StyleTemp6DDArrow = styled.div`
    ...
    z-index: 10001;
`
export const StyleTemp6DDContainer = styled.div`
