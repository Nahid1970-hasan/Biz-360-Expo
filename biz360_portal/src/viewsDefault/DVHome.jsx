                                    ...
                                    <InfoCard>
                                        <Flex row="true">
                                            {section4data?.data?.map((d, i) =>
                                                <Flex key={i} md={3}>
                                                    <CompProductDetailsCard username={username} onClick={() => gotoPage(d.id, "item")} height={"200px"} src={d.url || ""} price={d.price || ""} priceoff={d.priceoff || ""} label={"Title " + d.label} />
                                                </Flex>)}
                                        </Flex>
                                    </InfoCard>
                                </Flex>
                                    ...
                                    <InfoCard>
                                        <Flex row="true">
                                            {sectio5data?.data?.map((d, i) =>
                                                <Flex key={i} md={3}>
                                                    <CompProductDetailsCard username={username} onClick={() => gotoPage(d.id, "item")} height={"200px"} src={d.url || ""} tag={d.tag || ""} price={d.price || ""} priceoff={d.priceoff || ""} label={"Title " + d.label} />
                                                </Flex>)}
                                        </Flex>
                                    </InfoCard>
                                </Flex>
